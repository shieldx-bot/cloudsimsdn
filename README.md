java -cp target/cloudsimsdn-1.0-with-dependencies.jar:cloudsim-4.0.jar org.cloudbus.cloudsim.sdn.example.SimpleExample MFF sdn-example-physical.json sdn-example-virtual.json sdn-example-workload-normal-user.csv
